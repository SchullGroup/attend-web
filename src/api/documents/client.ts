...
export const documentsClient = {
   ...
   * `downloadUrl`/`fileUrl` directly — those are bare Cloudinary URLs a browser can open
   * without ever touching this backend, so nothing server-side could count them (§27).
