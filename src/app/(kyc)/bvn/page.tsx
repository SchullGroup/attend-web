  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      <div>
        ...
        <h1 className="text-xl font-bold text-foreground">BVN & Face Match</h1>
      ...
      <div className="space-y-3">
        <label className="block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
          Face Verification Photo <span className="text-red-500">*</span>
        </label>
        ...
        {isCameraActive ? (
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-gray-900 bg-slate-900 p-4 text-white">
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" variant="outline" size="sm" onClick={stopCamera} className="bg-white/10 text-white hover:bg-white/20 border-transparent">
                Cancel
              </Button>
            </div>
          </div>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <Button type="submit" fullWidth loading={isPending} disabled={!isValid}>
          {isPending ? "Verifying…" : "Verify BVN & Photo"}
        </Button>
      </div>
    </form>
  );
