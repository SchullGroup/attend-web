      ...
      <div className="flex flex-col gap-4 p-5 md:flex-row md:items-start">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1.5">
              <Users className="h-3.5 w-3.5" /> {e.rsvpCount.toLocaleString()}{" "}
              attending
            </span>
          </div>
          ...
          {!isVerified ? (
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              <Link href="/intro">
                <Button size="sm">
                  <ShieldAlert className="mr-1.5 h-3.5 w-3.5" /> Complete KYC to
                  register
                </Button>
              </Link>
            </div>
              ...
              <div className="flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-600/80">
                    Your CHN is not on this company's register. You can view
                    event details but cannot vote or register.
                  </p>
                </div>
              </div>
              <Link href={`/events/${e.id}`}>
