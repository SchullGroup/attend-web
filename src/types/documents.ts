 ...
 * `eventTitle` do come back — both render on /profile/documents — so they stay here, but anything
...
export interface ParticipantDocument {
   ...
   * separately from `originalFilename` — so this is always the right field to display, and a title
