...
export interface ProxyData {
  ...
  proxyPhone: string;
  assignedAt: string;
  /** Random 10-digit code generated by the backend (§10). Give to the proxy holder. */
  proxyCode?: string;
  /**
   * Signed (HMAC) QR payload (§11). Render as a QR on the receipt; scanning it and
   * submitting the raw string as `code` at /join signs the holder in as a proxy —
